...
function App() {
  ...
  const [formData, setFormData] = useState({
    ...
    expiryDate: new Date().toISOString().split('T')[0], // Set expiry same as start date
  ...
  useEffect(() => {
    if (formData.startDate) {
      // Set expiry date same as start date (for single day subscription)
    ...
    <div className="app-container">
      <div className="header-banner">
        <h1>
          ...
          Daily Demo Subscribers List
        </h1>
        <p>Manage all your daily demo subscribers</p>
      </div>
      ...
      {activeTab === 'view' && (
        <div className="subscriber-list">
          <h2>Daily Demo Subscribers ({subscribers.length})</h2>
